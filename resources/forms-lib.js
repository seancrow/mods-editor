...
function forms_onload() {
    ...
    forms_onloadHandlers = null;
		...
		// added by PAB - scroll to lastSubmitter, if any
			var d = document;
			var lastSubmitterName = d.getElementById("lastSubmitter").value;
			if (lastSubmitterName != '') {
				e = d.getElementById(lastSubmitterName);
				e.scrollIntoView(false);
				displayNode = e.parentNode.parentNode;
				displayNode.style.background = '#600';
				displayNode.style.color = '#fff';
				displayNode.style.border = '3px solid red';
			}
		// end of patch
}
